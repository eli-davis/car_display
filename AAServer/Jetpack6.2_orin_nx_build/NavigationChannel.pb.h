...
#ifndef GOOGLE_PROTOBUF_INCLUDED_NavigationChannel_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_NavigationChannel_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_NavigationChannel_2eproto
...
struct TableStruct_NavigationChannel_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_NavigationChannel_2eproto;
namespace tag {
namespace aas {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::tag::aas::NavigationChannel* Arena::CreateMaybeMessage<::tag::aas::NavigationChannel>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tag {
namespace aas {
...
class NavigationChannel PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tag.aas.NavigationChannel) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tag.aas.NavigationChannel";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_NavigationChannel_2eproto);
    return ::descriptor_table_NavigationChannel_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:tag.aas.NavigationChannel)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_NavigationChannel_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 NavigationChannel::minimum_interval_ms() const {
  // @@protoc_insertion_point(field_get:tag.aas.NavigationChannel.minimum_interval_ms)
...
inline void NavigationChannel::set_minimum_interval_ms(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:tag.aas.NavigationChannel.minimum_interval_ms)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 NavigationChannel::type() const {
  // @@protoc_insertion_point(field_get:tag.aas.NavigationChannel.type)
...
inline void NavigationChannel::set_type(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:tag.aas.NavigationChannel.type)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_NavigationChannel_2eproto
