...
#ifndef GOOGLE_PROTOBUF_INCLUDED_VideoResolution_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_VideoResolution_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_VideoResolution_2eproto
...
struct TableStruct_VideoResolution_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_VideoResolution_2eproto;
namespace tag {
namespace aas {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::tag::aas::VideoResolution* Arena::CreateMaybeMessage<::tag::aas::VideoResolution>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tag {
namespace aas {
...
enum VideoResolution_Enum : int {
  ...
  VideoResolution_Enum_H480 = 1,
  VideoResolution_Enum_H720 = 2,
  VideoResolution_Enum_H1080 = 3
};
...
constexpr VideoResolution_Enum VideoResolution_Enum_Enum_MAX = VideoResolution_Enum_H1080;
...
class VideoResolution PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tag.aas.VideoResolution) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tag.aas.VideoResolution";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_VideoResolution_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  static constexpr Enum H480 =
    VideoResolution_Enum_H480;
  static constexpr Enum H720 =
    VideoResolution_Enum_H720;
  static constexpr Enum H1080 =
    VideoResolution_Enum_H1080;
  ...
  // @@protoc_insertion_point(class_scope:tag.aas.VideoResolution)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_VideoResolution_2eproto;
};
// ===================================================================
...
template <> struct is_proto_enum< ::tag::aas::VideoResolution_Enum> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::tag::aas::VideoResolution_Enum>() {
  return ::tag::aas::VideoResolution_Enum_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_VideoResolution_2eproto
