...
#ifndef GOOGLE_PROTOBUF_INCLUDED_VideoConfig_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_VideoConfig_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_VideoConfig_2eproto
...
struct TableStruct_VideoConfig_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_VideoConfig_2eproto;
namespace tag {
namespace aas {
class VideoConfig;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::tag::aas::VideoConfig* Arena::CreateMaybeMessage<::tag::aas::VideoConfig>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tag {
namespace aas {
...
class VideoConfig PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tag.aas.VideoConfig) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_VideoConfig_2eproto);
    return ::descriptor_table_VideoConfig_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  ::tag::aas::VideoResolution_Enum video_resolution() const;
  void set_video_resolution(::tag::aas::VideoResolution_Enum value);
  private:
  ::tag::aas::VideoResolution_Enum _internal_video_resolution() const;
  void _internal_set_video_resolution(::tag::aas::VideoResolution_Enum value);
  public:
  ...
  ::tag::aas::VideoFps_Enum video_fps() const;
  void set_video_fps(::tag::aas::VideoFps_Enum value);
  private:
  ::tag::aas::VideoFps_Enum _internal_video_fps() const;
  void _internal_set_video_fps(::tag::aas::VideoFps_Enum value);
  public:
  ...
  // @@protoc_insertion_point(class_scope:tag.aas.VideoConfig)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_VideoConfig_2eproto;
};
// ===================================================================
...
inline ::tag::aas::VideoResolution_Enum VideoConfig::_internal_video_resolution() const {
  return static_cast< ::tag::aas::VideoResolution_Enum >(video_resolution_);
}
inline ::tag::aas::VideoResolution_Enum VideoConfig::video_resolution() const {
  // @@protoc_insertion_point(field_get:tag.aas.VideoConfig.video_resolution)
  return _internal_video_resolution();
}
inline void VideoConfig::_internal_set_video_resolution(::tag::aas::VideoResolution_Enum value) {
  assert(::tag::aas::VideoResolution_Enum_IsValid(value));
  _has_bits_[0] |= 0x00000001u;
  video_resolution_ = value;
}
inline void VideoConfig::set_video_resolution(::tag::aas::VideoResolution_Enum value) {
  _internal_set_video_resolution(value);
  // @@protoc_insertion_point(field_set:tag.aas.VideoConfig.video_resolution)
}
...
inline ::tag::aas::VideoFps_Enum VideoConfig::_internal_video_fps() const {
  return static_cast< ::tag::aas::VideoFps_Enum >(video_fps_);
}
inline ::tag::aas::VideoFps_Enum VideoConfig::video_fps() const {
  // @@protoc_insertion_point(field_get:tag.aas.VideoConfig.video_fps)
  return _internal_video_fps();
}
inline void VideoConfig::_internal_set_video_fps(::tag::aas::VideoFps_Enum value) {
  assert(::tag::aas::VideoFps_Enum_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  video_fps_ = value;
}
inline void VideoConfig::set_video_fps(::tag::aas::VideoFps_Enum value) {
  _internal_set_video_fps(value);
  // @@protoc_insertion_point(field_set:tag.aas.VideoConfig.video_fps)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 VideoConfig::margin_width() const {
  // @@protoc_insertion_point(field_get:tag.aas.VideoConfig.margin_width)
...
inline void VideoConfig::set_margin_width(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:tag.aas.VideoConfig.margin_width)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 VideoConfig::margin_height() const {
  // @@protoc_insertion_point(field_get:tag.aas.VideoConfig.margin_height)
...
inline void VideoConfig::set_margin_height(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:tag.aas.VideoConfig.margin_height)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 VideoConfig::dpi() const {
  // @@protoc_insertion_point(field_get:tag.aas.VideoConfig.dpi)
...
inline void VideoConfig::set_dpi(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:tag.aas.VideoConfig.dpi)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 VideoConfig::additional_depth() const {
  // @@protoc_insertion_point(field_get:tag.aas.VideoConfig.additional_depth)
...
inline void VideoConfig::set_additional_depth(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:tag.aas.VideoConfig.additional_depth)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_VideoConfig_2eproto
