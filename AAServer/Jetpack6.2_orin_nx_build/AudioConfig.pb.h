...
#ifndef GOOGLE_PROTOBUF_INCLUDED_AudioConfig_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_AudioConfig_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_AudioConfig_2eproto
...
struct TableStruct_AudioConfig_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_AudioConfig_2eproto;
namespace tag {
namespace aas {
class AudioConfig;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::tag::aas::AudioConfig* Arena::CreateMaybeMessage<::tag::aas::AudioConfig>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tag {
namespace aas {
...
class AudioConfig PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tag.aas.AudioConfig) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_AudioConfig_2eproto);
    return ::descriptor_table_AudioConfig_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:tag.aas.AudioConfig)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_AudioConfig_2eproto;
};
// ===================================================================
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 AudioConfig::sample_rate() const {
  // @@protoc_insertion_point(field_get:tag.aas.AudioConfig.sample_rate)
...
inline void AudioConfig::set_sample_rate(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:tag.aas.AudioConfig.sample_rate)
}

// required uint32 bits_per_sample = 2;
inline bool AudioConfig::_internal_has_bits_per_sample() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool AudioConfig::has_bits_per_sample() const {
  return _internal_has_bits_per_sample();
}
inline void AudioConfig::clear_bits_per_sample() {
  bits_per_sample_ = 0u;
  _has_bits_[0] &= ~0x00000002u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 AudioConfig::_internal_bits_per_sample() const {
  return bits_per_sample_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 AudioConfig::bits_per_sample() const {
  // @@protoc_insertion_point(field_get:tag.aas.AudioConfig.bits_per_sample)
  return _internal_bits_per_sample();
}
inline void AudioConfig::_internal_set_bits_per_sample(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000002u;
  bits_per_sample_ = value;
}
inline void AudioConfig::set_bits_per_sample(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_bits_per_sample(value);
  // @@protoc_insertion_point(field_set:tag.aas.AudioConfig.bits_per_sample)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 AudioConfig::channel_count() const {
  // @@protoc_insertion_point(field_get:tag.aas.AudioConfig.channel_count)
...
inline void AudioConfig::set_channel_count(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:tag.aas.AudioConfig.channel_count)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_AudioConfig_2eproto
